...
|
*/
$config['encryption_key'] = 'starsesat_ci_opentutorials';  // 최대 32 글자
...
$config['sess_save_path'] = 'ci_session';  // db 로 할시 테이블 지정
$config['sess_match_ip'] = TRUE;  // 보안을 위하여 설정. session 을 ip 까지 확인.
